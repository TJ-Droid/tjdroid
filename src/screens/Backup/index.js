...
export default function Backup() {
  ...
  // const [isAutomaticBackupCopy, setIsAutomaticBackupCopy] = useState(false);
  ...
  return (
    <Container>
      ...
      <SectionDivider>
        <SectionDividerText>{t("screens.backup.manual_backup")}</SectionDividerText>
        <StyledZipIcon>.zip</StyledZipIcon>
      </SectionDivider>

      <ItemListColumn>
        <TouchableOpacity activeOpacity={0.8} style={{width: '100%'}} onPress={() => generateManualBackup()}>
          <StyledFeatherButtonWrapper bgColor="#2186B1" marginBottom="10px">
            <StyledFeatherButtonLeftOverlay>
              <StyledFeatherButtonLeftIcon name="package"/>
            </StyledFeatherButtonLeftOverlay>
            <StyledFeatherButtonText>{t("screens.backup.generate_backup")} .zip</StyledFeatherButtonText>
          </StyledFeatherButtonWrapper>
        </TouchableOpacity>

        <TouchableOpacity activeOpacity={0.8} style={{width: '100%'}} onPress={() => restoreManualBackup()}>
          <StyledFeatherButtonWrapper bgColor="#195734" marginBottom="0px">
            <StyledFeatherButtonLeftOverlay>
              <StyledFeatherButtonLeftIcon name="arrow-down-circle"/>
            </StyledFeatherButtonLeftOverlay>
            <StyledFeatherButtonText>{t("screens.backup.restore_backup")} .zip</StyledFeatherButtonText>
          </StyledFeatherButtonWrapper>
        </TouchableOpacity>
      </ItemListColumn>
